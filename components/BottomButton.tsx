...
export default function BottomButton({
    ...
    const baseClasses = 'w-full py-4 rounded-full font-medium text-base transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2';
